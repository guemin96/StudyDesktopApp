...
namespace BookRentalShopApp
{
    public partial class FrmBooks : MetroForm
    {
        ...
        private void AsignToControls(DataGridViewRow selData)
        {
            ...
            //ReleaseDate
            DtpReleaseDate.Text = selData.Cells[5].Value.ToString();
        ...
        private void InitCboData()
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(Helper.Common.ConnString))
                {
                    ...
                    CboDivision.DataSource = new BindingSource(temp, null); //dataMember ull
